...
/**
 * A rewrite rule that maps a generate-ac VOMS request on a given port to 
 * a given web app context.
 * 
...
public class VOMSRewriteRule extends Rule implements Rule.ApplyURI{
	...
	/**
	 * A map of the replaced targets, built when the rewrite rule
	 * is constructed to get a more efficient implementation.
	 */
